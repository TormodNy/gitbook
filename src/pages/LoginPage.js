...
import { getAccessToken, oauthAuthorize } from "../api/ApiUtils";
  ...
  return (
    <div className="m-auto pt-1 p-4 xl:w-[50vw] md:w-[80vw] flex flex-col gap-2 bg-slate-200 rounded-lg">
      <div className="flex flex-col p-2 w-full gap-4">
        ...
        <p>
          To use GitBook you have to authenticate yourself with a GitHub access
          token which gives the app access to reading and publishing to public
        ...
        <Button
          ...
          disabled={!accept || !tempToken}
        >
          Authenticate
        </Button>

        <Button variant="contained" onClick={oauthAuthorize}>
          Sign in
        </Button>
      </div>
    </div>
